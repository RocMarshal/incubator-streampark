...
public class ThrowsTest {
  ...
  static final String pureMsgTpl = "Pure test string.";
  static final String msgTpl = "Template string %s.";
  static final String arg = "Hello";
  static final String renderedStr = String.format(msgTpl, arg);
  ...
  void testThrowIfTrue() {
    ...
    assertThatThrownBy(() -> Throws.throwIfTrue(true, AlertException.class, pureMsgTpl))
        .isInstanceOf(AlertException.class)
        .hasMessage(pureMsgTpl);
    assertThatThrownBy(() -> Throws.throwIfTrue(true, AlertException.class, msgTpl, arg))
        .isInstanceOf(AlertException.class)
        .hasMessage(renderedStr);
    ...
    Throws.throwIfTrue(false, AlertException.class, pureMsgTpl);
    Throws.throwIfTrue(false, AlertException.class, msgTpl, arg);
  ...
  void testThrowIfFalse() {
    ...
    assertThatThrownBy(() -> Throws.throwIfFalse(false, AlertException.class))
        .hasCauseInstanceOf(NoSuchMethodException.class);
    assertThatThrownBy(() -> Throws.throwIfFalse(false, AlertException.class, pureMsgTpl))
        .isInstanceOf(AlertException.class)
        .hasMessage(pureMsgTpl);
    assertThatThrownBy(() -> Throws.throwIfFalse(false, AlertException.class, msgTpl, arg))
        .isInstanceOf(AlertException.class)
        .hasMessage(renderedStr);
    ...
    Throws.throwIfFalse(true, AlertException.class, pureMsgTpl);
    Throws.throwIfFalse(true, AlertException.class, msgTpl, arg);
  ...
  void testThrowIfNull() {
    ...
    assertThatThrownBy(() -> Throws.throwIfNull(null, AlertException.class))
        .hasCauseInstanceOf(NoSuchMethodException.class);
    assertThatThrownBy(() -> Throws.throwIfNull(null, AlertException.class, pureMsgTpl))
        .isInstanceOf(AlertException.class)
        .hasMessage(pureMsgTpl);
    assertThatThrownBy(() -> Throws.throwIfNull(null, AlertException.class, msgTpl, arg))
        .isInstanceOf(AlertException.class)
        .hasMessage(renderedStr);
    ...
    Throws.throwIfNull(this, AlertException.class, pureMsgTpl);
    Throws.throwIfNull(this, AlertException.class, msgTpl, arg);
  ...
  void testThrowIfNonnull() {
    ...
    assertThatThrownBy(() -> Throws.throwIfNonnull(this, AlertException.class))
        .hasCauseInstanceOf(NoSuchMethodException.class);
    assertThatThrownBy(() -> Throws.throwIfNonnull(this, AlertException.class, pureMsgTpl))
        .isInstanceOf(AlertException.class)
        .hasMessage(pureMsgTpl);
    assertThatThrownBy(() -> Throws.throwIfNonnull(this, AlertException.class, msgTpl, arg))
        .isInstanceOf(AlertException.class)
        .hasMessage(renderedStr);
    ...
    Throws.throwIfNonnull(null, AlertException.class, pureMsgTpl);
    Throws.throwIfNonnull(null, AlertException.class, msgTpl, arg);
