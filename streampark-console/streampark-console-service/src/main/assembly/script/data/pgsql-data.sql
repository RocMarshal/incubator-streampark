...
insert into "public"."t_menu" values (100047, 100000, 'menu.memberManagement', '/system/member', 'system/member/Member', null, 'usergroup-add', '0', '1', 2, now(), now());
insert into "public"."t_menu" values (100048, 100047, 'add', null, null, 'member:add', null, '1', '1', null, now(), now());
insert into "public"."t_menu" values (100049, 100047, 'update', null, null, 'member:update', null, '1', '1', null, now(), now());
insert into "public"."t_menu" values (100050, 100047, 'delete', null, null, 'member:delete', null, '1', '1', null, now(), now());
...
insert into "public"."t_menu" values (100063, 100047, 'view', null, null, 'member:view', null, '1', '1', null, now(), now());
...
insert into "public"."t_menu" values (100072, 100033, 'update yarn queue', null, null, 'yarnQueue:update', '', '1', '0', null, now(), now());
