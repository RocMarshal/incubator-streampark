...
public interface ApplicationMapper extends BaseMapper<Application> {
    ...
    List<String> getRecentK8sClusterId(
            @Param("executionMode") int executionMode, @Param("limitSize") int limit);

    @Select(
            "select flink_image from "
    ...
    @Select(
            "select k8s_jm_pod_template from "
    ...
    @Select(
            "select k8s_tm_pod_template from "
