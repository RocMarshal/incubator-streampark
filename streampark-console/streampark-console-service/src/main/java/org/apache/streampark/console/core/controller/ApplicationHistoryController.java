...
public class ApplicationHistoryController {
    ...
    public RestResponse listUploadJars() {
        List<String> jars =
                applicationHistoryService.listUploadJars(
                        StorageType.LFS, DEFAULT_HISTORY_RECORD_LIMIT);
    ...
    public RestResponse listK8sNamespace() {
        List<String> namespaces =
                applicationMapper.getRecentK8sNamespace(DEFAULT_HISTORY_RECORD_LIMIT);
    ...
    public RestResponse listSessionClusterId(int executionMode) {
        ...
        switch (ExecutionMode.of(executionMode)) {
            ...
            case REMOTE:
                clusterIds =
                        applicationMapper.getRecentK8sClusterId(
                                executionMode, DEFAULT_HISTORY_RECORD_LIMIT);
                break;
            default:
    ...
    public RestResponse listFlinkBaseImage() {
        List<String> images =
                applicationMapper.getRecentFlinkBaseImage(DEFAULT_HISTORY_RECORD_LIMIT);
    ...
    public RestResponse listPodTemplate() {
        List<String> templates =
                applicationMapper.getRecentK8sPodTemplate(DEFAULT_HISTORY_POD_TMPL_RECORD_LIMIT);
    ...
    public RestResponse listJmPodTemplate() {
        List<String> templates =
                applicationMapper.getRecentK8sJmPodTemplate(DEFAULT_HISTORY_POD_TMPL_RECORD_LIMIT);
        return RestResponse.success(templates);
    }
    ...
    public RestResponse listTmPodTemplate() {
        List<String> templates =
                applicationMapper.getRecentK8sTmPodTemplate(DEFAULT_HISTORY_POD_TMPL_RECORD_LIMIT);
        return RestResponse.success(templates);
    }
}
