...
public class CheckPoints implements Serializable {
  ...
  @JsonIgnore
  public List<CheckPoint> getLatestChkAndSavepointWithTimeAscOrder() {
    if (Objects.isNull(latest)) {
      return Collections.emptyList();
    }
    return latest.getChkAndSavepointWithTimeAscOrder();
  }
  ...
  public static class Latest implements Serializable {
    ...
    @JsonIgnore
    public List<CheckPoint> getChkAndSavepointWithTimeAscOrder() {
      ...
      return checkPoints.stream()
          .sorted(Comparator.comparingLong(chk -> chk.triggerTimestamp))
