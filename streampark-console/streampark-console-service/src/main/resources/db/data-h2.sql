...
insert into `t_menu` values (100076, 100034, 'add yarn queue', null, null, 'yarnQueue:create', '', '1', 0, null, now(), now());
insert into `t_menu` values (100077, 100034, 'edit yarn queue', null, null, 'yarnQueue:update', '', '1', 0, null, now(), now());
insert into `t_menu` values (100078, 100034, 'delete yarn queue', null, null, 'yarnQueue:delete', '', '1', 0, null, now(), now());
