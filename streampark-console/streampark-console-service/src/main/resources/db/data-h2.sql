...
insert into `t_menu` values (100072, 100034, 'add yarn queue', null, null, 'yarnQueue:create', '', '1', 0, null, now(), now());
insert into `t_menu` values (100073, 100034, 'edit yarn queue', null, null, 'yarnQueue:update', '', '1', 0, null, now(), now());
