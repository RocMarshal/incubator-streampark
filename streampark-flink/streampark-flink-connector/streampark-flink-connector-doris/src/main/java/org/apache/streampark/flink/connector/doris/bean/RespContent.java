...
public class RespContent implements Serializable {
    ...
    /**
     * Import complete status. "Success": Indicates that the import was successful. "Publish
     * Timeout": This status also indicates that the import has been completed, but the data may be
     * visible with a delay, and there is no need to retry. "Label Already Exists": The Label is
     * duplicated, and the Label needs to be replaced.
     */
    @JsonProperty(value = "Status")
    private String status;
    /**
     * The status of the import job corresponding to the existing Label. This field will only be
     * displayed when the Status is "Label Already Exists". The user can know the status of the
     * import job corresponding to the existing Label through this status. "RUNNING" means that the
     * job is still executing, and "FINISHED" means that the job is successful.
     */
